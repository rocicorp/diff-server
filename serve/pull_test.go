...
func TestAPIV1(t *testing.T) {
	...
	tc := []struct {
		...
		{"POST",
			`{"baseStateID": "s3n5j759kirvvs3fqeott07a43lk41ud", "checksum": "c4e7090d", "clientID": "clientid", "clientViewAuth": "clientauth", "version": 1}`,
			"accountID",
			"cv",
			"",
			"clientauth",
		...
		{"POST",
			`{"baseStateID": "00000000000000000000000000000000", "checksum": "00000000", "clientViewAuth": "clientauth", "version": 1}`,
			"accountID",
			"",
			"",
			"",
		...
		// Invalid baseStateID.
		{"POST",
			`{"baseStateID": "beep", "checksum": "00000000", "clientID": "clientid", "clientViewAuth": "clientauth", "version": 1}`,
			"accountID",
			"",
			"",
			"",
		...
		{"POST",
			`{"baseStateID": "", "checksum": "00000000", "clientID": "clientid", "clientViewAuth": "clientauth", "version": 1}`,
			"accountID",
			"cv",
			"",
			"clientauth",
		...
		// Invalid checksum.
		{"POST",
			`{"baseStateID": "00000000000000000000000000000000", "checksum": "not", "clientID": "clientid", "clientViewAuth": "clientauth", "version": 1}`,
			"accountID",
			"",
			"",
			"",
